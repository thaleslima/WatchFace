...
public class SunshineSyncTask {
    ...
    synchronized public static void syncWeather(Context context) {
        ...
        try {
            ...
            if (weatherValues != null && weatherValues.length != 0) {
                ...
                sendDataToWatch(context, weatherValues[0]);
    ...
    private static void sendDataToWatch(Context context, ContentValues cv) {
        GoogleApiClient mGoogleApiClient = new GoogleApiClient.Builder(context)
                .addApi(Wearable.API)
                .build();
        mGoogleApiClient.blockingConnect(10, TimeUnit.SECONDS);
        PutDataMapRequest dataMap = PutDataMapRequest.create (WATCHFACE_DATA_PATH);
